...
import { DatabaseDiffInfo, DatabaseInfo } from '@/model/db-info';
...
interface CompareDbPageProps {

}

const CompareDbSchemaPage: React.FC<CompareDbPageProps> = () => {

    const dbInfoRef = useRef<{ source?: DatabaseInfo, target?: DatabaseInfo }>({});
    ...
    const handleDbInfoCollected = (data: DatabaseInfo, key: string) => {
        key === 'source' && (dbInfoRef.current.source = data);
        key === 'target' && (dbInfoRef.current.target = data);
    };
    ...
    return (<>
        ...
        <Container maxWidth="lg">
            ...
            <Stack direction="row" spacing={2} sx={{ padding: '20px 0' }}>
                ...
                <Tooltip title="Clear">
                    <Fab size="medium" color="primary" aria-label="add" onClick={handleClear}>
                        <CleaningServicesIcon />
                    </Fab>
                </Tooltip>
                <Tooltip title="Start Compare">
                    <Fab size="medium" color="success" aria-label="add" onClick={startCompare}>
                        <PlayArrowIcon />
                    </Fab>
                </Tooltip>
            </Stack>
            <Fade in={showResult} unmountOnExit >
                <Box>
                    ...
                    <Box sx={{ padding: '20px 0' }}>
                        <DatabaseComparedTable rows={compareRes} />
                    </Box>
                </Box>
            </Fade>
        </Container>
